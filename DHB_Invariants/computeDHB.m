...
% Input: p -> position or linear velocity (Nx3 array) 
%        d -> rotation vector or angular velocity (Nx3 array)
%
...
function [m_p, theta_p_1, theta_p_2, m_r, theta_r_1, theta_r_2, H_p, H_r] = computeDHB(p, theta)
